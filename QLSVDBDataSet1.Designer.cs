...
namespace L2_LoginForm {
    ...
    public partial class QLSVDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(int id, string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture_) {
        ...
        public partial class stdRow : global::System.Data.DataRow {
            ...
            public byte[] picture_ {
                get {
                    try {
                        return ((byte[])(this[this.tablestd.picture_Column]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tablestd.picture_Column] = value;
                }
            }
            ...
            public bool Ispicture_Null() {
                return this.IsNull(this.tablestd.picture_Column);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setpicture_Null() {
                this[this.tablestd.picture_Column] = global::System.Convert.DBNull;
            }
        }
...
namespace L2_LoginForm.QLSVDBDataSet1TableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[std] ([id], [fname], [lname], [bdate], [gender], [phone], [address], [picture ]) VALUES (@id, @fname, @lname, @bdate, @gender, @phone, @address, @picture_);
SELECT id, fname, lname, bdate, gender, phone, address, [picture ] FROM std WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [id] = @id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [address] = @address, [picture ] = @picture_ WHERE (([id] = @Original_id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)));
SELECT id, fname, lname, bdate, gender, phone, address, [picture ] FROM std WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::L2_LoginForm.Properties.Settings.Default.QLSVDBConnectionString;
        }
        ...
        public virtual int Insert(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string address, byte[] picture_) {
            ...
            if ((picture_ == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[7].Value = ((byte[])(picture_));
            }
        ...
        public virtual int Update(int id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string address, byte[] picture_, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_address) {
            ...
            if ((picture_ == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((byte[])(picture_));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string address, byte[] picture_, int Original_id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_address) {
            return this.Update(Original_id, fname, lname, bdate, gender, phone, address, picture_, Original_id, Original_fname, Original_lname, Original_bdate, Original_gender, Original_phone, Original_address);
        }
    }
